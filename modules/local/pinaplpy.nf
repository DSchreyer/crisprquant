...
process PINAPLPY {
    ...
    conda (params.enable_conda ? "anaconda::yaml=0.2.5 conda-forge::pyyaml=5.4.1 more-itertools=8.7.0 pandas=1.2.4 xlrd=1.2.0 openpyxl=3.0.7 joblib=1.0.1 basemap=1.3.0 bioconda::pysam=0.16.0 scipy=1.6.2" : null)
