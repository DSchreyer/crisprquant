...
process MAGECK_COUNT {
    ...
    if (workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container) {
        container "https://depot.galaxyproject.org/singularity/mageck:0.5.9.4--py38hed8969a_0"
    } else {
        container "quay.io/biocontainers/mageck:0.5.9.4--py38hed8969a_0"
    }
...
//    path "*.version.txt"          , emit: version
    ...
    mageck count \
        ...
        --sample-label $id \
        --fastq $file
    mageck --version > ${software}.version.txt
    """
}
